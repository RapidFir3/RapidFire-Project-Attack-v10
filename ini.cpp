...
static void ini_init ( void )
{
	...
	if ((ent = ini_register_entry("Unsynch_Radius", TYPE_INT)) != NULL)
		...
		ini_register_data(ent, &set.silentAim.uiMinHitChanceValue, "100");
		...
		if ((ent = ini_register_entry("Invalid_Bullets_Crasher_Delays", TYPE_INT)) != NULL)
			ini_register_data(ent, &set.invalidBullets.dwDelayOfInvalidBullets, "100");
