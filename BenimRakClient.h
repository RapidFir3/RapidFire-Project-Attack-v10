...
public:
	...
	void TakeDamage(int iPlayerID, float fDamage, int iWeaponID, int iBodyPart);
	void SendFakePassengerSyncData(WORD vehicleid, float fPos[3], float HealthCar, uint8_t WeaponID, int SeatID);
